(Menu 1.1.0. ©Sem Noah Boven. All rights reserved.)
@echo off
:menu_logo
Title Menu 1.1.0
cls
...
echo.
echo.
echo   1.1.0                                                                                       Copyright Sem Noah Boven
...
echo.
echo Nieuwe pagina: 'Wat is er nieuw.'
echo Nieuw spel: 'Tic Tac Toe.'
echo.
echo                           Copyright Sem Noah Boven
echo --------------------------------------------------
...
echo What's new?
echo.
echo New page: 'What's new.'
echo New game: 'Tic Tac Toe.'
echo.
echo                           Copyright Sem Noah Boven
echo --------------------------------------------------
