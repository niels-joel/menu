(Menu 1.4.1. ©Sem Noah Boven. All rights reserved.)
@echo off
:menu_logo
Title Menu 1.4.1
cls
...
echo.
echo.
echo   1.4.1                                                                                       Copyright Sem Noah Boven
...
if "%input%" == "Bestandslocatie Openen" goto open_file_location_nl
if "%input%" == "BESTANDSLOCATIE OPENEN" goto open_file_location_nl
if "%input%" == "4" calc & goto menu_nl
if "%input%" == "rekenmachine" calc & goto menu_nl
if "%input%" == "Rekenmachine" calc & goto menu_nl
if "%input%" == "REKENMACHINE" calc & goto menu_nl
if "%input%" == "5" goto settings_nl
if "%input%" == "instellingen" goto settings_nl
if "%input%" == "Instellingen" goto settings_nl
if "%input%" == "INSTELLINGEN" goto settings_nl
if "%input%" == "6" goto exit_nl
...
if "%input%" == "1-1" goto colors_failed_nl
if "%input%" == "rood-rood" goto colors_failed_nl
if "%input%" == "Rood-rood" goto colors_failed_nl
if "%input%" == "Rood-Rood" goto colors_failed_nl
if "%input%" == "ROOD-ROOD" goto colors_failed_nl
if "%input%" == "1-2" color 64 & goto colors_nl
if "%input%" == "rood-geel" color 64 & goto colors_nl
if "%input%" == "Rood-geel" color 64 & goto colors_nl
if "%input%" == "Rood-Geel" color 64 & goto colors_nl
if "%input%" == "ROOD-GEEL" color 64 & goto colors_nl
if "%input%" == "1-3" color 24 & goto colors_nl
if "%input%" == "rood-groen" color 24 & goto colors_nl
if "%input%" == "Rood-groen" color 24 & goto colors_nl
if "%input%" == "Rood-Groen" color 24 & goto colors_nl
if "%input%" == "ROOD-GROEN" color 24 & goto colors_nl
if "%input%" == "1-4" color 14 & goto colors_nl
if "%input%" == "rood-blauw" color 14 & goto colors_nl
if "%input%" == "Rood-blauw" color 14 & goto colors_nl
if "%input%" == "Rood-Blauw" color 14 & goto colors_nl
if "%input%" == "ROOD-BLAUW" color 14 & goto colors_nl
if "%input%" == "1-5" color 74 & goto colors_nl
if "%input%" == "rood-wit" color 74 & goto colors_nl
if "%input%" == "Rood-wit" color 74 & goto colors_nl
if "%input%" == "Rood-Wit" color 74 & goto colors_nl
if "%input%" == "ROOD-WIT" color 74 & goto colors_nl
if "%input%" == "1-6" color 84 & goto colors_nl
if "%input%" == "rood-grijs" color 84 & goto colors_nl
if "%input%" == "Rood-grijs" color 84 & goto colors_nl
if "%input%" == "Rood-Grijs" color 84 & goto colors_nl
if "%input%" == "ROOD-GRIJS" color 84 & goto colors_nl
if "%input%" == "1-7" color 04 & goto colors_nl
if "%input%" == "rood-zwart" color 04 & goto colors_nl
if "%input%" == "Rood-zwart" color 04 & goto colors_nl
if "%input%" == "Rood-Zwart" color 04 & goto colors_nl
if "%input%" == "ROOD-ZWART" color 04 & goto colors_nl
if "%input%" == "2-1" color 46 & goto colors_nl
if "%input%" == "geel-rood" color 46 & goto colors_nl
if "%input%" == "Geel-rood" color 46 & goto colors_nl
if "%input%" == "Geel-Rood" color 46 & goto colors_nl
if "%input%" == "GEEL-ROOD" color 46 & goto colors_nl
if "%input%" == "2-2" goto colors_failed_nl
if "%input%" == "geel-geel" goto colors_failed_nl
if "%input%" == "Geel-geel" goto colors_failed_nl
if "%input%" == "Geel-Geel" goto colors_failed_nl
if "%input%" == "GEEL-GEEL" goto colors_failed_nl
if "%input%" == "2-3" color 26  & goto colors_nl
if "%input%" == "geel-groen" color 26 & goto colors_nl
if "%input%" == "Geel-groen" color 26 & goto colors_nl
if "%input%" == "Geel-Groen" color 26 & goto colors_nl
if "%input%" == "GEEL-GROEN" color 26 & goto colors_nl
if "%input%" == "2-4" color 16 & goto colors_nl
if "%input%" == "geel-blauw" color 16 & goto colors_nl
if "%input%" == "Geel-blauw" color 16 & goto colors_nl
if "%input%" == "Geel-Blauw" color 16 & goto colors_nl
if "%input%" == "GEEL-BLAUW" color 16 & goto colors_nl
if "%input%" == "2-5" color 76 & goto colors_nl
if "%input%" == "geel-wit" color 76 & goto colors_nl
if "%input%" == "Geel-wit" color 76 & goto colors_nl
if "%input%" == "Geel-Wit" color 76 & goto colors_nl
if "%input%" == "GEEL-WIT" color 76 & goto colors_nl
if "%input%" == "2-6" color 86 & goto colors_nl
if "%input%" == "geel-grijs" color 86 & goto colors_nl
if "%input%" == "Geel-grijs" color 86 & goto colors_nl
if "%input%" == "Geel-Grijs" color 86 & goto colors_nl
if "%input%" == "GEEL-GRIJS" color 86 & goto colors_nl
if "%input%" == "2-7" color 06 & goto colors_nl
if "%input%" == "geel-zwart" color 06 & goto colors_nl
if "%input%" == "Geel-zwart" color 06 & goto colors_nl
if "%input%" == "Geel-Zwart" color 06 & goto colors_nl
if "%input%" == "GEEL-ZWART" color 06 & goto colors_nl
if "%input%" == "3-1" color 42 & goto colors_nl
if "%input%" == "groen-rood" color 42 & goto colors_nl
if "%input%" == "Groen-rood" color 42 & goto colors_nl
if "%input%" == "Groen-Rood" color 42 & goto colors_nl
if "%input%" == "GROEN-ROOD" color 42 & goto colors_nl
if "%input%" == "3-2" color 62 & goto colors_nl
if "%input%" == "groen-geel" color 62 & goto colors_nl
if "%input%" == "Groen-geel" color 62 & goto colors_nl
if "%input%" == "Groen-Geel" color 62 & goto colors_nl
if "%input%" == "GROEN-GEEL" color 62 & goto colors_nl
if "%input%" == "3-3" goto colors_failed_nl
if "%input%" == "groen-groen" goto colors_failed_nl
if "%input%" == "Groen-groen" goto colors_failed_nl
if "%input%" == "Groen-Groen" goto colors_failed_nl
if "%input%" == "GROEN-GROEN" goto colors_failed_nl
if "%input%" == "3-4" color 12 & goto colors_nl
if "%input%" == "groen-blauw" color 12 & goto colors_nl
if "%input%" == "Groen-blauw" color 12 & goto colors_nl
if "%input%" == "Groen-Blauw" color 12 & goto colors_nl
if "%input%" == "GROEN-BLAUW" color 12 & goto colors_nl
if "%input%" == "3-5" color 72 & goto colors_nl
if "%input%" == "groen-wit" color 72 & goto colors_nl
if "%input%" == "Groen-wit" color 72 & goto colors_nl
if "%input%" == "Groen-Wit" color 72 & goto colors_nl
if "%input%" == "GROEN-WIT" color 72 & goto colors_nl
if "%input%" == "3-6" color 82 & goto colors_nl
if "%input%" == "groen-grijs" color 82 & goto colors_nl
if "%input%" == "Groen-grijs" color 82 & goto colors_nl
if "%input%" == "Groen-Grijs" color 82 & goto colors_nl
if "%input%" == "GROEN-GRIJS" color 82 & goto colors_nl
if "%input%" == "3-7" color 02 & goto colors_nl
if "%input%" == "groen-zwart" color 02 & goto colors_nl
if "%input%" == "Groen-zwart" color 02 & goto colors_nl
if "%input%" == "Groen-Zwart" color 02 & goto colors_nl
if "%input%" == "GROEN-ZWART" color 02 & goto colors_nl
if "%input%" == "4-1" color 41 & goto colors_nl
if "%input%" == "blauw-rood" color 41 & goto colors_nl
if "%input%" == "Blauw-rood" color 41 & goto colors_nl
if "%input%" == "Blauw-Rood" color 41 & goto colors_nl
if "%input%" == "BLAUW-ROOD" color 41 & goto colors_nl
if "%input%" == "4-2" color 61 & goto colors_nl
if "%input%" == "blauw-geel" color 61 & goto colors_nl
if "%input%" == "Blauw-geel" color 61 & goto colors_nl
if "%input%" == "Blauw-Geel" color 61 & goto colors_nl
if "%input%" == "BLAUW-GEEL" color 61 & goto colors_nl
if "%input%" == "4-3" color 21 & goto colors_nl
if "%input%" == "blauw-groen" color 21 & goto colors_nl
if "%input%" == "Blauw-groen" color 21 & goto colors_nl
if "%input%" == "Blauw-Groen" color 21 & goto colors_nl
if "%input%" == "BLAUW-GROEN" color 21 & goto colors_nl
if "%input%" == "4-4" goto colors_failed_nl
if "%input%" == "blauw-blauw" goto colors_failed_nl
if "%input%" == "Blauw-blauw" goto colors_failed_nl
if "%input%" == "Blauw-Blauw" goto colors_failed_nl
if "%input%" == "BLAUW-BLAUW" goto colors_failed_nl
if "%input%" == "4-5" color 71 & goto colors_nl
if "%input%" == "blauw-wit" color 71 & goto colors_nl
if "%input%" == "Blauw-wit" color 71 & goto colors_nl
if "%input%" == "Blauw-Wit" color 71 & goto colors_nl
if "%input%" == "BLAUW-WIT" color 71 & goto colors_nl
if "%input%" == "4-6" color 81 & goto colors_nl
if "%input%" == "blauw-grijs" color 81 & goto colors_nl
if "%input%" == "Blauw-grijs" color 81 & goto colors_nl
if "%input%" == "Blauw-Grijs" color 81 & goto colors_nl
if "%input%" == "BLAUW-GRIJS" color 81 & goto colors_nl
if "%input%" == "4-7" color 01 & goto colors_nl
if "%input%" == "blauw-zwart" color 01 & goto colors_nl
if "%input%" == "Blauw-zwart" color 01 & goto colors_nl
if "%input%" == "Blauw-Zwart" color 01 & goto colors_nl
if "%input%" == "BLAUW-ZWART" color 01 & goto colors_nl
if "%input%" == "5-1" color 47 & goto colors_nl
if "%input%" == "wit-rood" color 47 & goto colors_nl
if "%input%" == "Wit-rood" color 47 & goto colors_nl
if "%input%" == "Wit-Rood" color 47 & goto colors_nl
if "%input%" == "WIT-ROOD" color 47 & goto colors_nl
if "%input%" == "5-2" color 67 & goto colors_nl
if "%input%" == "wit-geel" color 67 & goto colors_nl
if "%input%" == "Wit-geel" color 67 & goto colors_nl
if "%input%" == "Wit-Geel" color 67 & goto colors_nl
if "%input%" == "WIT-GEEL" color 67 & goto colors_nl
if "%input%" == "5-3" color 27 & goto colors_nl
if "%input%" == "wit-groen" color 27 & goto colors_nl
if "%input%" == "Wit-groen" color 27 & goto colors_nl
if "%input%" == "Wit-Groen" color 27 & goto colors_nl
if "%input%" == "WIT-GROEN" color 27 & goto colors_nl
if "%input%" == "5-4" color 17 & goto colors_nl
if "%input%" == "wit-blauw" color 17 & goto colors_nl
if "%input%" == "Wit-blauw" color 17 & goto colors_nl
if "%input%" == "Wit-Blauw" color 17 & goto colors_nl
if "%input%" == "WIT-BLAUW" color 17 & goto colors_nl
if "%input%" == "5-5" goto colors_failed_nl
if "%input%" == "wit-wit" goto colors_failed_nl
if "%input%" == "Wit-wit" goto colors_failed_nl
if "%input%" == "Wit-Wit" goto colors_failed_nl
if "%input%" == "WIT-WIT" goto colors_failed_nl
if "%input%" == "5-6" color 87 & goto colors_nl
if "%input%" == "wit-grijs" color 87 & goto colors_nl
if "%input%" == "Wit-grijs" color 87 & goto colors_nl
if "%input%" == "Wit-Grijs" color 87 & goto colors_nl
if "%input%" == "WIT-GRIJS" color 87 & goto colors_nl
if "%input%" == "5-7" color 07 & goto colors_nl
if "%input%" == "wit-zwart" color 07 & goto colors_nl
if "%input%" == "Wit-zwart" color 07 & goto colors_nl
if "%input%" == "Wit-Zwart" color 07 & goto colors_nl
if "%input%" == "WIT-ZWART" color 07 & goto colors_nl
if "%input%" == "6-1" color 48 & goto colors_nl
if "%input%" == "grijs-rood" color 48 & goto colors_nl
if "%input%" == "Grijs-rood" color 48 & goto colors_nl
if "%input%" == "Grijs-Rood" color 48 & goto colors_nl
if "%input%" == "GRIJS-ROOD" color 48 & goto colors_nl
if "%input%" == "6-2" color 68 & goto colors_nl
if "%input%" == "grijs-geel" color 68 & goto colors_nl
if "%input%" == "Grijs-geel" color 68 & goto colors_nl
if "%input%" == "Grijs-Geel" color 68 & goto colors_nl
if "%input%" == "GRIJS-GEEL" color 68 & goto colors_nl
if "%input%" == "6-3" color 28 & goto colors_nl
if "%input%" == "grijs-groen" color 28 & goto colors_nl
if "%input%" == "Grijs-groen" color 28 & goto colors_nl
if "%input%" == "Grijs-Groen" color 28 & goto colors_nl
if "%input%" == "GRIJS-GROEN" color 28 & goto colors_nl
if "%input%" == "6-4" color 18 & goto colors_nl
if "%input%" == "grijs-blauw" color 18 & goto colors_nl
if "%input%" == "Grijs-blauw" color 18 & goto colors_nl
if "%input%" == "Grijs-Blauw" color 18 & goto colors_nl
if "%input%" == "GRIJS-BLAUW" color 18 & goto colors_nl
if "%input%" == "6-5" color 78 & goto colors_nl
if "%input%" == "grijs-wit" color 78 & goto colors_nl
if "%input%" == "Grijs-wit" color 78 & goto colors_nl
if "%input%" == "Grijs-Wit" color 78 & goto colors_nl
if "%input%" == "GRIJS-WIT" color 78 & goto colors_nl
if "%input%" == "6-6" goto colors_failed_nl
if "%input%" == "grijs-grijs" goto colors_failed_nl
if "%input%" == "Grijs-grijs" goto colors_failed_nl
if "%input%" == "Grijs-Grijs" goto colors_failed_nl
if "%input%" == "GRIJS-GRIJS" goto colors_failed_nl
if "%input%" == "6-7" color 08 & goto colors_nl
if "%input%" == "grijs-zwart" color 08 & goto colors_nl
if "%input%" == "Grijs-zwart" color 08 & goto colors_nl
if "%input%" == "Grijs-Zwart" color 08 & goto colors_nl
if "%input%" == "GRIJS-ZWART" color 08 & goto colors_nl
if "%input%" == "7-1" color 40 & goto colors_nl
if "%input%" == "zwart-rood" color 40 & goto colors_nl
if "%input%" == "Zwart-rood" color 40 & goto colors_nl
if "%input%" == "Zwart-Rood" color 40 & goto colors_nl
if "%input%" == "ZWART-ROOD" color 40 & goto colors_nl
if "%input%" == "7-2" color 60 & goto colors_nl
if "%input%" == "zwart-geel" color 60 & goto colors_nl
if "%input%" == "Zwart-geel" color 60 & goto colors_nl
if "%input%" == "Zwart-Geel" color 60 & goto colors_nl
if "%input%" == "ZWART-GEEL" color 60 & goto colors_nl
if "%input%" == "7-3" color 20 & goto colors_nl
if "%input%" == "zwart-groen" color 20 & goto colors_nl
if "%input%" == "Zwart-groen" color 20 & goto colors_nl
if "%input%" == "Zwart-Groen" color 20 & goto colors_nl
if "%input%" == "ZWART-GROEN" color 20 & goto colors_nl
if "%input%" == "7-4" color 10 & goto colors_nl
if "%input%" == "zwart-blauw" color 10 & goto colors_nl
if "%input%" == "Zwart-blauw" color 10 & goto colors_nl
if "%input%" == "Zwart-Blauw" color 10 & goto colors_nl
if "%input%" == "ZWART-BLAUW" color 10 & goto colors_nl
if "%input%" == "7-5" color 70 & goto colors_nl
if "%input%" == "zwart-wit" color 70 & goto colors_nl
if "%input%" == "Zwart-wit" color 70 & goto colors_nl
if "%input%" == "Zwart-Wit" color 70 & goto colors_nl
if "%input%" == "ZWART-WIT" color 70 & goto colors_nl
if "%input%" == "7-6" color 80 & goto colors_nl
if "%input%" == "zwart-grijs" color 80 & goto colors_nl
if "%input%" == "Zwart-grijs" color 80 & goto colors_nl
if "%input%" == "Zwart-Grijs" color 80 & goto colors_nl
if "%input%" == "ZWART-GRIJS" color 80 & goto colors_nl
if "%input%" == "7-7" goto colors_failed_nl
if "%input%" == "zwart-zwart" goto colors_failed_nl
if "%input%" == "Zwart-zwart" goto colors_failed_nl
if "%input%" == "Zwart-Zwart" goto colors_failed_nl
if "%input%" == "ZWART-ZWART" goto colors_failed_nl
...
if "%input%" == "Open File Location" goto open_file_location_en
if "%input%" == "OPEN FILE LOCATION" goto open_file_location_en
if "%input%" == "4" calc & goto menu_en
if "%input%" == "calculator" calc & goto menu_en
if "%input%" == "Calculator" calc & goto menu_en
if "%input%" == "CALCULATOR" calc & goto menu_en
if "%input%" == "5" goto settings_en
if "%input%" == "settings" goto settings_en
if "%input%" == "Settings" goto settings_en
if "%input%" == "SETTINGS" goto settings_en
if "%input%" == "6" goto exit_en
...
if "%input%" == "1-1" goto colors_failed_en
if "%input%" == "red-red" goto colors_failed_en
if "%input%" == "Red-red" goto colors_failed_en
if "%input%" == "Red-Red" goto colors_failed_en
if "%input%" == "RED-RED" goto colors_failed_en
if "%input%" == "1-2" color 64 & goto colors_en
if "%input%" == "red-yellow" color 64 & goto colors_en
if "%input%" == "Red-yellow" color 64 & goto colors_en
if "%input%" == "Red-Yellow" color 64 & goto colors_en
if "%input%" == "Red-YELLOW" color 64 & goto colors_en
if "%input%" == "1-3" color 24 & goto colors_en
if "%input%" == "red-green" color 24 & goto colors_en
if "%input%" == "Red-green" color 24 & goto colors_en
if "%input%" == "Red-Green" color 24 & goto colors_en
if "%input%" == "RED-GREEN" color 24 & goto colors_en
if "%input%" == "1-4" color 14 & goto colors_en
if "%input%" == "red-blue" color 14 & goto colors_en
if "%input%" == "Red-blue" color 14 & goto colors_en
if "%input%" == "Red-Blue" color 14 & goto colors_en
if "%input%" == "RED-BLUE" color 14 & goto colors_en
if "%input%" == "1-5" color 74 & goto colors_en
if "%input%" == "red-white" color 74 & goto colors_en
if "%input%" == "Red-white" color 74 & goto colors_en
if "%input%" == "Red-White" color 74 & goto colors_en
if "%input%" == "RED-WHITE" color 74 & goto colors_en
if "%input%" == "1-6" color 84 & goto colors_en
if "%input%" == "red-gray" color 84 & goto colors_en
if "%input%" == "Red-gray" color 84 & goto colors_en
if "%input%" == "Red-Gray" color 84 & goto colors_en
if "%input%" == "RED-GRAY" color 84 & goto colors_en
if "%input%" == "1-7" color 04 & goto colors_en
if "%input%" == "red-black" color 04 & goto colors_en
if "%input%" == "Red-black" color 04 & goto colors_en
if "%input%" == "Red-Black" color 04 & goto colors_en
if "%input%" == "RED-BLACK" color 04 & goto colors_en
if "%input%" == "2-1" color 46 & goto colors_en
if "%input%" == "yellow-red" color 46 & goto colors_en
if "%input%" == "Yellow-red" color 46 & goto colors_en
if "%input%" == "Yellow-Red" color 46 & goto colors_en
if "%input%" == "YELLOW-RED" color 46 & goto colors_en
if "%input%" == "2-2" goto colors_failed_en
if "%input%" == "yellow-yellow" goto colors_failed_en
if "%input%" == "Yellow-yellow" goto colors_failed_en
if "%input%" == "Yellow-Yellow" goto colors_failed_en
if "%input%" == "YELLOW-YELLOW" goto colors_failed_en
if "%input%" == "2-3" color 26 & goto colors_en
if "%input%" == "yellow-green" color 26 & goto colors_en
if "%input%" == "Yellow-green" color 26 & goto colors_en
if "%input%" == "Yellow-Green" color 26 & goto colors_en
if "%input%" == "YELLOW-GREEN" color 26 & goto colors_en
if "%input%" == "2-4" color 16 & goto colors_en
if "%input%" == "yellow-blue" color 16 & goto colors_en
if "%input%" == "Yellow-blue" color 16 & goto colors_en
if "%input%" == "Yellow-Blue" color 16 & goto colors_en
if "%input%" == "YELLOW-BLUE" color 16 & goto colors_en
if "%input%" == "2-5" color 76 & goto colors_en
if "%input%" == "yellow-white" color 76 & goto colors_en
if "%input%" == "Yellow-white" color 76 & goto colors_en
if "%input%" == "Yellow-White" color 76 & goto colors_en
if "%input%" == "YELLOW-WHITE" color 76 & goto colors_en
if "%input%" == "2-6" color 86 & goto colors_en
if "%input%" == "yellow-gray" color 86 & goto colors_en
if "%input%" == "Yellow-gray" color 86 & goto colors_en
if "%input%" == "Yellow-Gray" color 86 & goto colors_en
if "%input%" == "YELLOW-GRAY" color 86 & goto colors_en
if "%input%" == "2-7" color 06 & goto colors_en
if "%input%" == "yellow-black" color 06 & goto colors_en
if "%input%" == "Yellow-black" color 06 & goto colors_en
if "%input%" == "Yellow-Black" color 06 & goto colors_en
if "%input%" == "YELLOW-BLACK" color 06 & goto colors_en
if "%input%" == "3-1" color 42 & goto colors_en
if "%input%" == "green-red" color 42 & goto colors_en
if "%input%" == "Green-red" color 42 & goto colors_en
if "%input%" == "Green-Red" color 42 & goto colors_en
if "%input%" == "GREEN-RED" color 42 & goto colors_en
if "%input%" == "3-2" color 62 & goto colors_en
if "%input%" == "green-yellow" color 62 & goto colors_en
if "%input%" == "Green-yellow" color 62 & goto colors_en
if "%input%" == "Green-Yellow" color 62 & goto colors_en
if "%input%" == "GREEN-YELLOW" color 62 & goto colors_en
if "%input%" == "3-3" goto colors_failed_en
if "%input%" == "green-green" goto colors_failed_en
if "%input%" == "Green-green" goto colors_failed_en
if "%input%" == "Green-Green" goto colors_failed_en
if "%input%" == "GREEN-GREEN" goto colors_failed_en
if "%input%" == "3-4" color 12 & goto colors_en
if "%input%" == "green-blue" color 12 & goto colors_en
if "%input%" == "Green-blue" color 12 & goto colors_en
if "%input%" == "Green-Blue" color 12 & goto colors_en
if "%input%" == "GREEN-BLUE" color 12 & goto colors_en
if "%input%" == "3-5" color 72 & goto colors_en
if "%input%" == "green-white" color 72 & goto colors_en
if "%input%" == "Green-white" color 72 & goto colors_en
if "%input%" == "Green-White" color 72 & goto colors_en
if "%input%" == "GREEN-WHITE" color 72 & goto colors_en
if "%input%" == "3-6" color 82 & goto colors_en
if "%input%" == "green-gray" color 82 & goto colors_en
if "%input%" == "Green-gray" color 82 & goto colors_en
if "%input%" == "Green-Gray" color 82 & goto colors_en
if "%input%" == "GREEN-GRAY" color 82 & goto colors_en
if "%input%" == "3-7" color 02 & goto colors_en
if "%input%" == "green-black" color 02 & goto colors_en
if "%input%" == "Green-black" color 02 & goto colors_en
if "%input%" == "Green-Black" color 02 & goto colors_en
if "%input%" == "GREEN-BLACK" color 02 & goto colors_en
if "%input%" == "4-1" color 41 & goto colors_en
if "%input%" == "blue-red" color 41 & goto colors_en
if "%input%" == "Blue-red" color 41 & goto colors_en
if "%input%" == "Blue-Red" color 41 & goto colors_en
if "%input%" == "BLUE-RED" color 41 & goto colors_en
if "%input%" == "4-2" color 61 & goto colors_en
if "%input%" == "blue-yellow" color 61 & goto colors_en
if "%input%" == "Blue-yellow" color 61 & goto colors_en
if "%input%" == "Blue-Yellow" color 61 & goto colors_en
if "%input%" == "BLUE-YELLOW" color 61 & goto colors_en
if "%input%" == "4-3" color 21 & goto colors_en
if "%input%" == "blue-green" color 21 & goto colors_en
if "%input%" == "Blue-green" color 21 & goto colors_en
if "%input%" == "Blue-Green" color 21 & goto colors_en
if "%input%" == "BLUE-GREEN" color 21 & goto colors_en
if "%input%" == "4-4" goto colors_failed_en
if "%input%" == "blue-blue" goto colors_failed_en
if "%input%" == "Blue-blue" goto colors_failed_en
if "%input%" == "Blue-Blue" goto colors_failed_en
if "%input%" == "BLUE-BLUE" goto colors_failed_en
if "%input%" == "4-5" color 71 & goto colors_en
if "%input%" == "blue-white" color 71 & goto colors_en
if "%input%" == "Blue-white" color 71 & goto colors_en
if "%input%" == "Blue-White" color 71 & goto colors_en
if "%input%" == "BLUE-WHITE" color 71 & goto colors_en
if "%input%" == "4-6" color 81 & goto colors_en
if "%input%" == "blue-gray" color 81 & goto colors_en
if "%input%" == "Blue-gray" color 81 & goto colors_en
if "%input%" == "Blue-Gray" color 81 & goto colors_en
if "%input%" == "BLUE-GRAY" color 81 & goto colors_en
if "%input%" == "4-7" color 01 & goto colors_en
if "%input%" == "blue-black" color 01 & goto colors_en
if "%input%" == "Blue-black" color 01 & goto colors_en
if "%input%" == "Blue-Black" color 01 & goto colors_en
if "%input%" == "BLUE-BLACK" color 01 & goto colors_en
if "%input%" == "5-1" color 47 & goto colors_en
if "%input%" == "white-red" color 47 & goto colors_en
if "%input%" == "White-red" color 47 & goto colors_en
if "%input%" == "White-Red" color 47 & goto colors_en
if "%input%" == "WHITE-RED" color 47 & goto colors_en
if "%input%" == "5-2" color 67 & goto colors_en
if "%input%" == "white-yellow" color 67 & goto colors_en
if "%input%" == "White-yellow" color 67 & goto colors_en
if "%input%" == "White-Yellow" color 67 & goto colors_en
if "%input%" == "WHITE-YELLOW" color 67 & goto colors_en
if "%input%" == "5-3" color 27 & goto colors_en
if "%input%" == "white-green" color 27 & goto colors_en
if "%input%" == "White-green" color 27 & goto colors_en
if "%input%" == "White-Green" color 27 & goto colors_en
if "%input%" == "WHITE-GREEN" color 27 & goto colors_en
if "%input%" == "5-4" color 17 & goto colors_en
if "%input%" == "white-blue" color 17 & goto colors_en
if "%input%" == "White-blue" color 17 & goto colors_en
if "%input%" == "White-Blue" color 17 & goto colors_en
if "%input%" == "WHITE-BLUE" color 17 & goto colors_en
if "%input%" == "5-5" goto colors_failed_en
if "%input%" == "white-white" goto colors_failed_en
if "%input%" == "White-white" goto colors_failed_en
if "%input%" == "White-White" goto colors_failed_en
if "%input%" == "WHITE-WHITE" goto colors_failed_en
if "%input%" == "5-6" color 87 & goto colors_en
if "%input%" == "white-gray" color 87 & goto colors_en
if "%input%" == "White-gray" color 87 & goto colors_en
if "%input%" == "White-Gray" color 87 & goto colors_en
if "%input%" == "WHITE-GRAY" color 87 & goto colors_en
if "%input%" == "5-7" color 07 & goto colors_en
if "%input%" == "white-black" color 07 & goto colors_en
if "%input%" == "White-black" color 07 & goto colors_en
if "%input%" == "White-Black" color 07 & goto colors_en
if "%input%" == "WHITE-BLACK" color 07 & goto colors_en
if "%input%" == "6-1" color 48 & goto colors_en
if "%input%" == "gray-red" color 48 & goto colors_en
if "%input%" == "Gray-red" color 48 & goto colors_en
if "%input%" == "Gray-Red" color 48 & goto colors_en
if "%input%" == "GRAY-RED" color 48 & goto colors_en
if "%input%" == "6-2" color 68 & goto colors_en
if "%input%" == "gray-yellow" color 68 & goto colors_en
if "%input%" == "Gray-yellow" color 68 & goto colors_en
if "%input%" == "Gray-Yellow" color 68 & goto colors_en
if "%input%" == "GRAY-YELLOW" color 68 & goto colors_en
if "%input%" == "6-3" color 28 & goto colors_en
if "%input%" == "gray-green" color 28 & goto colors_en
if "%input%" == "Gray-green" color 28 & goto colors_en
if "%input%" == "Gray-Green" color 28 & goto colors_en
if "%input%" == "GRAY-GREEN" color 28 & goto colors_en
if "%input%" == "6-4" color 18 & goto colors_en
if "%input%" == "gray-blue" color 18 & goto colors_en
if "%input%" == "Gray-blue" color 18 & goto colors_en
if "%input%" == "Gray-Blue" color 18 & goto colors_en
if "%input%" == "GRAY-BLUE" color 18 & goto colors_en
if "%input%" == "6-5" color 78 & goto colors_en
if "%input%" == "gray-white" color 78 & goto colors_en
if "%input%" == "Gray-white" color 78 & goto colors_en
if "%input%" == "Gray-White" color 78 & goto colors_en
if "%input%" == "GRAY-WHITE" color 78 & goto colors_en
if "%input%" == "6-6" goto colors_failed_en
if "%input%" == "gray-gray" goto colors_failed_en
if "%input%" == "Gray-gray" goto colors_failed_en
if "%input%" == "Gray-Gray" goto colors_failed_en
if "%input%" == "GRAY-GRAY" goto colors_failed_en
if "%input%" == "6-7" color 08 & goto colors_en
if "%input%" == "gray-black" color 08 & goto colors_en
if "%input%" == "Gray-black" color 08 & goto colors_en
if "%input%" == "Gray-Black" color 08 & goto colors_en
if "%input%" == "GRAY-BLACK" color 08 & goto colors_en
if "%input%" == "7-1" color 40 & goto colors_en
if "%input%" == "black-red" color 40 & goto colors_en
if "%input%" == "Black-red" color 40 & goto colors_en
if "%input%" == "Black-Red" color 40 & goto colors_en
if "%input%" == "BLACK-RED" color 40 & goto colors_en
if "%input%" == "7-2" color 60 & goto colors_en
if "%input%" == "black-yellow" color 60 & goto colors_en
if "%input%" == "Black-yellow" color 60 & goto colors_en
if "%input%" == "Black-Yellow" color 60 & goto colors_en
if "%input%" == "BLACK-YELLOW" color 60 & goto colors_en
if "%input%" == "7-3" color 20 & goto colors_en
if "%input%" == "black-green" color 20 & goto colors_en
if "%input%" == "Black-green" color 20 & goto colors_en
if "%input%" == "Black-Green" color 20 & goto colors_en
if "%input%" == "BLACK-GREEN" color 20 & goto colors_en
if "%input%" == "7-4" color 10 & goto colors_en
if "%input%" == "black-blue" color 10 & goto colors_en
if "%input%" == "Black-blue" color 10 & goto colors_en
if "%input%" == "Black-Blue" color 10 & goto colors_en
if "%input%" == "BLACK-BLUE" color 10 & goto colors_en
if "%input%" == "7-5" color 70 & goto colors_en
if "%input%" == "black-white" color 70 & goto colors_en
if "%input%" == "Black-white" color 70 & goto colors_en
if "%input%" == "Black-White" color 70 & goto colors_en
if "%input%" == "BLACK-WHITE" color 70 & goto colors_en
if "%input%" == "7-6" color 80 & goto colors_en
if "%input%" == "black-gray" color 80 & goto colors_en
if "%input%" == "Black-gray" color 80 & goto colors_en
if "%input%" == "Black-Gray" color 80 & goto colors_en
if "%input%" == "BLACK-GRAY" color 80 & goto colors_en
if "%input%" == "7-7" goto colors_failed_en
if "%input%" == "black-black" goto colors_failed_en
if "%input%" == "Black-black" goto colors_failed_en
if "%input%" == "Black-Black" goto colors_failed_en
if "%input%" == "BLACK-BLACK" goto colors_failed_en
