(Menu 1.2.1. ©Sem Noah Boven. All rights reserved.)
@echo off
:menu_logo
Title Menu 1.2.1
cls
...
echo.
echo.
echo   1.2.1                                                                                       Copyright Sem Noah Boven
...
if "%input%" == "0000" goto coming_soon_nl
...
echo                                      %date%
echo.
echo Nieuwe editie komt eraan!
echo.
echo Op 1 februari 2024...
echo.
echo                           Copyright Sem Noah Boven
echo --------------------------------------------------
...
if "%input%" == "Ja" goto menu_nl
if "%input%" == "JA" goto menu_nl
if "%input%" == "nee" goto coming_soon_nl
if "%input%" == "Nee" goto coming_soon_nl
if "%input%" == "NEE" goto coming_soon_nl
goto coming_soon_nl_failed

:coming_soon_nl_failed
Title Nieuwe editie
cls
echo --------------------------------------------------
echo                                      %date%
...
:notepad_nl_1
if "%notepad_title_1%" == "" goto notepad_nl_1_edit
if "%notepad_1%" == "" goto notepad_nl_1_edit
...
:notepad_nl_2
if "%notepad_title_2%" == "" goto notepad_nl_2_edit
if "%notepad_2%" == "" goto notepad_nl_2_edit
...
:notepad_nl_3
if "%notepad_title_3%" == "" goto notepad_nl_3_edit
if "%notepad_3%" == "" goto notepad_nl_3_edit
...
start cmd /k ".\Other Files\Menu Lite Beta.bat" & goto menu_lite_preview_nl

:start_menu_lite_2.0_pre-release_nl
start cmd /k ".\Other Files\Menu Lite 2.0 Pre-Release.bat" & goto menu_lite_preview_nl
...
if "%input%" == "0000" goto coming_soon_en
...
echo                                      %date%
echo.
echo New edition coming soon!
echo.
echo On februari 1st 2024...
echo.
echo                           Copyright Sem Noah Boven
echo --------------------------------------------------
...
if "%input%" == "Yes" goto menu_en
if "%input%" == "YES" goto menu_en
if "%input%" == "no" goto coming_soon_en
if "%input%" == "No" goto coming_soon_en
if "%input%" == "NO" goto coming_soon_en
goto coming_soon_en_failed

:coming_soon_en_failed
Title New edition
cls
echo --------------------------------------------------
echo                                      %date%
...
:notepad_en_1
if "%notepad_title_1%" == "" goto notepad_en_1_edit
if "%notepad_1%" == "" goto notepad_en_1_edit
Title %notepad_title_1%
cls
echo --------------------------------------------------
echo                                      %date%
...
:notepad_en_2
if "%notepad_title_2%" == "" goto notepad_en_2_edit
if "%notepad_2%" == "" goto notepad_en_2_edit
Title %notepad_title_2%
cls
echo --------------------------------------------------
echo                                      %date%
...
:notepad_en_3
if "%notepad_title_3%" == "" goto notepad_en_3_edit
if "%notepad_3%" == "" goto notepad_en_3_edit
Title %notepad_title_3%
cls
echo --------------------------------------------------
echo                                      %date%
...
start cmd /k ".\Other Files\Menu Lite Beta.bat" & goto menu_lite_preview_en

:start_menu_lite_2.0_pre-release_en
start cmd /k ".\Other Files\Menu Lite 2.0 Pre-Release.bat" & goto menu_lite_preview_en