(Menu 1.2.3. ©Sem Noah Boven. All rights reserved.)
@echo off
:menu_logo
Title Menu 1.2.3
cls
...
echo.
echo.
echo   1.2.3                                                                                       Copyright Sem Noah Boven
...
if "%input%" == "0000" goto new_edition_released_nl
...
:new_edition_released_nl
Title Nieuwe editie uitgekomen
cls
echo --------------------------------------------------
echo                                      %date%
echo.
echo Nieuwe editie is uitgekomen!
echo.
echo Het is... 'Menu Lite'
echo.
echo                           Copyright Sem Noah Boven
echo --------------------------------------------------
...
if "%input%" == "Ja" goto menu_nl
if "%input%" == "JA" goto menu_nl
if "%input%" == "nee" goto new_edition_released_nl
if "%input%" == "Nee" goto new_edition_released_nl
if "%input%" == "NEE" goto new_edition_released_nl
goto new_edition_released_nl_failed

:new_edition_released_nl_failed
Title Nieuwe editie uitgekomen
cls
echo --------------------------------------------------
echo                                      %date%
...
if "%input%" == "0000" goto new_edition_released_en
...
:new_edition_released_en
Title New edition released
cls
echo --------------------------------------------------
echo                                      %date%
echo.
echo New edition is released!
echo.
echo It is... 'Menu Lite'
echo.
echo                           Copyright Sem Noah Boven
echo --------------------------------------------------
set /p input="Do you want to go further to the menu?:"
if "%input%" == "yes" goto menu_en
if "%input%" == "Yes" goto menu_en
if "%input%" == "YES" goto menu_en
if "%input%" == "no" goto new_edition_released_en
if "%input%" == "No" goto new_edition_released_en
if "%input%" == "NO" goto new_edition_released_en
goto new_edition_released_en_failed

:new_edition_released_en_failed
Title New edition released
cls
echo --------------------------------------------------
echo                                      %date%
