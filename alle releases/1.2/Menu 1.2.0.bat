(Menu 1.2.0. ©Sem Noah Boven. All rights reserved.)
@echo off
:menu_logo
Title Menu 1.2.0
cls
...
echo.
echo.
echo   1.2.0                                                                                       Copyright Sem Noah Boven
...
if "%input%" == "0000" goto whats_new_nl
...
echo                                      %date%
echo.
echo Wat is er nieuw?
echo.
echo Kladblok toegevoegd.
echo.
echo                           Copyright Sem Noah Boven
echo --------------------------------------------------
...
if "%input%" == "Ja" goto menu_nl
if "%input%" == "JA" goto menu_nl
if "%input%" == "nee" goto whats_new_nl
if "%input%" == "Nee" goto whats_new_nl
if "%input%" == "NEE" goto whats_new_nl
goto whats_new_nl_failed
...
if "%input%" == "0000" goto whats_new_en
...
if "%input%" == "Yes" goto menu_en
if "%input%" == "YES" goto menu_en
if "%input%" == "no" goto whats_new_en
if "%input%" == "No" goto whats_new_en
if "%input%" == "NO" goto whats_new_en
goto whats_new_en_failed
