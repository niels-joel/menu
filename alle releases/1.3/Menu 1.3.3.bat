(Menu 1.3.3. ©Sem Noah Boven. All rights reserved.)
@echo off
:menu_logo
Title Menu 1.3.3
cls
...
echo.
echo.
echo   1.3.3                                                                                       Copyright Sem Noah Boven
...
echo Release datum: 6-5-2024
echo Gemaakt door: Sem Boven
echo.
echo Update-informatie:
echo Platform toegevoegd in versie-informatie
echo.
echo                           Copyright Sem Noah Boven
echo --------------------------------------------------
...
echo Version: 1.3.3
echo Platform: Windows
echo Release date: 6-5-2024
echo Made by: Sem Boven
echo.
echo Update-information:
echo Added platform in version-information
echo.
echo                           Copyright Sem Noah Boven
echo --------------------------------------------------
