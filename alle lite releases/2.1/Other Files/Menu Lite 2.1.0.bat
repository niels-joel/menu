(Menu Lite 2.1.0. ©Sem Noah Boven. All rights reserved.)
@echo off
:menu_logo
Title Menu Lite 2.1.0
cls
...
echo.
echo.
echo   Lite 2.1.0                                                                                  Copyright Sem Noah Boven
...
echo 1: Spellen
echo 2: Kladblok
echo 3: Bestandslocatie toevoegen
echo 4: Rekenmachine
echo 5: Instellingen
echo 6: Stoppen
echo.
...
echo.
echo Versie: Lite 2.1.0
echo Platform: Windows
echo Release datum: 7-5-2024
echo Gemaakt door: Sem Boven
echo.
echo Update-informatie:
echo Bestandslocatie openen toegevoegd
echo Rekenmachine toegevoegd
echo Versie-informatie toegevoegd
echo Logo toegevoegd
echo 'Wat is er nieuw' pagina verwijderd
echo Bugs gefixt
echo.
echo                           Copyright Sem Noah Boven
echo --------------------------------------------------
set /p input="Wil je terug?:"
if "%input%" == "y" goto settings_nl
goto version_information_nl
...
echo.
echo Version: Lite 2.1.0
echo Platform: Windows
echo Release date: 7-5-2024
echo Made by: Sem Boven
echo.
echo Update-information:
echo Added open file location
echo Added calculator
echo Added version-information
echo Added logo
echo Deleted the 'What's new' page
echo Fixed bugs
echo.
echo                           Copyright Sem Noah Boven
echo --------------------------------------------------
set /p input="Do you want to go back?:"
if "%input%" == "y" goto settings_en
goto version_information_en
